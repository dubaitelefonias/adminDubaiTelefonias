      ...
      body: Stack(
        children: <Widget>[
          Container(
            ...
            child: Center(
              child: Image.asset(
                'assets/images/logotipo2_negativo.png', // Cambia esto a la ruta de tu imagen PNG
                width: 280, // Ajusta el ancho de la imagen según tus necesidades
                height: 280, // Ajusta la altura de la imagen según tus necesidades
              ),
            ),
          ),
          Image.asset(
